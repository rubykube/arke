...
module SwaggerClient
  module API
    class Account
      ...
      # @param [Hash] opts the optional parameters
      # @return [Account]
      def balance_of(currency, opts = {})
        data, _status_code, _headers = get_account_balances_currency_with_http_info(currency, opts)
        data
      end

      # Returns deposit address for account you want to deposit to by currency.
      ...
      # @return [Deposit]
      def deposit_address_for(currency, opts = {})
      ...
      def get_account_balances_currency_with_http_info(currency, _opts = {})
      ...
      def get_account_deposit_address_currency_with_http_info(currency, opts = {})
        ...
        # query parameters
        query_params = {}
        query_params[:address_format] = opts[:address_format] unless opts[:address_format].nil?
      ...
      # @param [Hash] opts the optional parameters
      # @return [Array<(Deposit, Fixnum, Hash)>] Deposit data, response status code and response headers
      def get_account_deposits_txid_with_http_info(txid, _opts = {})
        if @api_client.config.debugging
      ...
      def get_account_balances_with_http_info(_opts = {})
        if @api_client.config.debugging
